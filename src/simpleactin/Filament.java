...
public class Filament implements SubUnitListener{
    ...
    int i = 0;
    public LinkedList<SubUnit> _subunits = null;
    double atpR, adppir,adppicor;
    ...
    public void setParams(PolymerizationRate barbed,PolymerizationRate pointed,
            ReactionRate cofilin, ReactionRate SRV2, double patpR, double padppir,
            int ptotalADF, int pdistance, int pchunksize) {
        atpR = patpR;
        adppir = padppir;
        totalADF = ptotalADF;
        distance = pdistance;
    ...
    public int dynamic(LinkedList<SubUnit> _subunits, PolymerizationRate rates, boolean barbed, double t) {
